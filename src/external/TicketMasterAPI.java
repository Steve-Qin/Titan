...
public class TicketMasterAPI implements ExternalAPI {
	...
	private static final String API_KEY = "QDHmzaXVekxNjsLnftDXsL7a0NPk60dj";
	...
	public List<Item> search(double lat, double lon, String term) {
		...
		try {
			...
			// if responseCode == 200 ==> we know it worked
			// else for example responseCode == 404 ==> ...
	...
	// manually make sure the input is a valid url.
	// e.g. convert space to "%20"
	...
	/**
	 * Helper methods : for debugging purpose, we set a private function to test if
	 * the returned JSONArray is valid.
	 */
