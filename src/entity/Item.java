...
public class Item {
	...
	// builder pattern
	// used to eliminate redundant and complicated combination of
	// constructors of Item class
	// we only use ItemBuilder to set all valid fields
	// and then convert to Item using private constructor
	...
	/**
	 * I implemented toString previously
	 * @Override
